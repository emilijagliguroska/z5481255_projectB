...
- [y] At least the required combined fund with two methods, backtested
      out-of-sample with no look-ahead, with a fact sheet.
- [y] streamlit_app.py runs locally: streamlit run streamlit_app.py.
- [y] The GitHub repo is PUBLIC and the live Streamlit app loads.
- [y] Raw data loads through src/data_access.py; no raw data or secrets committed.
